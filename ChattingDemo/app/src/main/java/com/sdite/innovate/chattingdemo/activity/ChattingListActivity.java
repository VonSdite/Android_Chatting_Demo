...
public class ChattingListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener()
        {
            ...
            {
                String name = friendsName.get(groupPosition).get(childPosition);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.quit:
                ActivityCollector.finishAll(ChattingListActivity.this);
                break;
            case 1:
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(Menu.NONE, 2, Menu.NONE, "注销");
        return true;
    }
    ...
    class MyExpandableListViewAdapter extends BaseExpandableListAdapter
    {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                convertView = LayoutInflater.from(context).inflate(R.layout.chatting_list_group, null);
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                convertView = LayoutInflater.from(context).inflate(R.layout.chatting_list_item, null);
